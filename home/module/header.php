<div class="container-fluid">
  <div class="row" id="first-header">
    ...
    <div class="col-md-6 py-2 px-3"> 
      <form action="/web_ban_hang/home/xu_ly_tim_kiem_tu_khoa.php" class="input-group-sm input-group" method="post">
        <input name="tu_khoa" type="text" class="form-control my-0 mr-0" placeholder="Từ khóa">
        <div class="input-group-append">
          <button type="submit" class="btn btn-sm btn-danger my-0">Tìm kiếm <i class="bi bi-search"></i></button>
        </div>
      </form>
    </div>
  </div>
  <div class="row">
    ...
    <nav class="navbar navbar-expand-lg">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item px-3"><a class="nav-link" href="/web_ban_hang/home/gio_hang.php"><i class="bi bi-basket"></i> Giỏ hàng</a></li>
      </ul>
      </div>
    </nav>
    </div>
