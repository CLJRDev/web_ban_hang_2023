...
<body>
	<div class="container-fluid px-0">
		...
		<form onsubmit="return check_form();" action="xu_ly_sua_nha_san_xuat.php" method="post" enctype="multipart/form-data">
			<div id="main" class="row no-gutters p-3">
				<?php 
					include '../module/header.php'; 
					include '../module/form_nha_san_xuat/form_sua_nha_san_xuat.php'; 
